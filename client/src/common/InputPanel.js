...
var InputPanel = cc.Layer.extend({
    ...
    init: function () {
        ...
        //定义表情菜单
        var faceButton = cc.MenuItemImage.create(s_face, s_face2, s_face, function () { alert("jsdk"); }, this);
        ...
        var CharButton = cc.MenuItemLabel.create(charLabel, function () { alert("sdsds"); }, this);
        ...
        //定义聊天记录开关
        this._viewButton = cc.MenuItemImage.create(s_openview, s_openview, s_closeview, this.changeViewVisible, this);
        this._viewButton.setPosition(cc.p(310, 20));


        //将所有的按钮加到菜单容器里面
        var menu = cc.Menu.create(faceButton, CharButton, crButton, this._viewButton);
        ...
        //定义聊天记录
        this.view = ViewPanel.create(cc.c4b(136, 136, 136, 55), 340, 155);
...
var Message = function () {
    ...
    this.init = function (String, maxLenth) {
     //   alert(String);
        ...
        this.CCLable = cc.LabelTTF.create(newStr, 'Microsoft YaHei', 12, cc.size(330, 20), cc.TEXT_ALIGNMENT_LEFT);
