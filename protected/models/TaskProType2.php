...
/**
 * This is the model class for table "sigma_taskpro_type2".
 *
 * The followings are the available columns in table 'sigma_taskpro_type2':
...
class TaskProType2 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TaskProType2 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('problem_name, problem_declare', 'required'),
			array('problem_type', 'numerical', 'integerOnly'=>true),
			array('problem_name, problem_answer', 'length', 'max'=>105),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('problem_id, problem_type, problem_name, problem_declare, problem_answer', 'safe', 'on'=>'search'),
		);
	}
